                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return LocationCard(
                            ...
                            imagePath: locationData[index]["imagePath"]!,
                          );
                        },
                      ),
                    ),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return RecommendedCard(
                            imagePath: recommendedData[index]["imagePath"]!,
                            price: recommendedData[index]["price"]!,
                            description: recommendedData[index]["description"]!,
                            details: recommendedData[index]["details"]!,
                          );
                        },
                      ),
                    ),
